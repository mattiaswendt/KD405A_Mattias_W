...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		//Varje station har ett ID i form av ett nummer, searchURL stoppar in dessa i XSDn samt hur många resultat som ska visas.
		...
		Journeys journeys = Parser.getJourneys(searchURL);  // använder XSDn genererad av searchURL för att hämta information om resan
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malm\"");
		ArrayList<Station> searchStations = new ArrayList<Station>(); // En arraylist som ska innehålla alla malmös stationer
		searchStations.addAll(Parser.getStationsFromURL("Malm")); // Hämtar alla stationer som innehåller "Malm"
